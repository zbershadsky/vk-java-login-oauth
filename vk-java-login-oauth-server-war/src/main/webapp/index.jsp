<%System.out.println(">>> index.jsp: begin");%>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head> 
      <meta http-equiv="content-type" content="text/html; charset=windows-1251" /> 
      <title>Open API sample page PUBLIC</title> 
      ...
      <script type="text/javascript">
         ...
         var access_token = "";
         if (hash_href != null && "" != hash_href && hash_href.indexOf("access_token")!= -1) {
            var beginIndex = hash_href.indexOf('access_token=') + "access_token=".length;
            var endIndex = hash_href.indexOf('&',beginIndex);
            access_token = hash_href.substring(beginIndex, endIndex);
         }
...
PUBLIC PAGE <a href="/vk/logout.jsp">logout</a><br/>
<br/>
<a href="http://moyakarta.dyndns.org/vk/private/ok">private</a><br/>
<br/>
